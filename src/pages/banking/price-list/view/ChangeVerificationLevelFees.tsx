...
import ViewChangeVerificationFees from "~/components/pricelist/ViewChangeVerificationFees";
...
import AddChangeVerificationFees from "~/components/pricelist/AddChangeVerificationFees";
...
const ChangeVerificationFees: FC<CommonPricelistProps> = () => {
...

    {
      ...
      getActions: () => [
        ...
        <GridActionsCellItem
          ...
          label="Edit"
          onClick={() => {
            enforcePermission("edit", [() => setOpenAdd("edit")]);
          }}
          showInMenu
          sx={{
            margin: "0 1rem",
    ...
    <Fragment>
      {!openAdd && (
        <div className=" flex items-center justify-between pb-8 pt-4 ">
          <Header head="Change verification level fees" />
      ...
      {openAdd === "edit" && (
        <div className=" pb-8 pt-4">
          <Header head="Edit Change verification level fees" />{" "}
        </div>
      )}
      {openAdd === "addNew" && (
        <div className=" pb-8 pt-4">
          <Header head="Add Change verification level fees" />{" "}
        </div>
      )}
      ...
      {!openAdd && (
        <>
          <div className="tableComponent">
            <Box sx={{ width: "100%" }}>
              <MuiDataGrid
                storageName="ChangeVerificationFees"
                checkboxSelection
                rows={rows}
                columns={columns}
                slotProps={{
                  toolbar: {
                    csvOptions: {
                      fileName: "Change verification level Report",
                    },
                  },
                }}
              />
...
export default ChangeVerificationFees;
