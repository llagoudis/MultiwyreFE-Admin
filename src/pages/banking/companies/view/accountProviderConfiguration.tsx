...
import AddAccountProvider from "~/pages/banking/companies/AddAccountProvider";
...
const AcProviderConfig = () => {
  ...
  const columns = [
    ...
    { flex: 1, minWidth: 180, field: "provider", headerName: "PROVIDER" },
    {
      flex: 1,
      minWidth: 150,
      field: "name",
    ...
    <Fragment>
      ...
      {!openDialog && (
        <div className="flex items-center justify-between py-4">
          <Header head={"Account provider configurations"} />
      ...
      {/* add staff  */}
      {openDialog && <AddAccountProvider />}
    </Fragment>
  );
};

export default AcProviderConfig;
